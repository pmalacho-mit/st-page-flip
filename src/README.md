...
`npm install flipflow`

Or download bundle from Github

### Usage

If you've installed the package from npm, you should import FlipFlow from flipflow package, or just use `<script/>` tag:

```html
<script src="{path/to/scripts}/flipflow.browser.js"></script>
```

To create a new FlipFlow object:
...
// or if you're using a script tag and flipflow.browser.js:
